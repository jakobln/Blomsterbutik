#pragma checksum "C:\Code\Blomsterbutik\Blomsterbutik\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C99FA0F7F3AFE783546A0ECB52970920"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IMainPage_Bindings
        {
            ...
            private void UpdateTwoWay_9_Text()
            {
                if (this.initialized)
                {
                    ...
                    {
                        this.dataRoot.Navn = this.obj9.Text;
                    }
                }
            }
            private void UpdateTwoWay_10_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        this.dataRoot.Antal = (global::System.Int32) global::Windows.UI.Xaml.Markup.XamlBindingHelper.ConvertValue(typeof(global::System.Int32), this.obj10.Text);
                    }
                }
            }
            private void UpdateTwoWay_11_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        this.dataRoot.Farve = this.obj11.Text;
                    }
                }
            }
